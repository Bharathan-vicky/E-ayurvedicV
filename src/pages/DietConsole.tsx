    ...
    <PageTransition>
      <div className="min-h-screen pt-24">
                  ...
                  <TabsContent value="meal-planner">
                    <div className="bg-card border border-border rounded-xl p-6 shadow-sm">
                      <h3 className="font-medium text-lg mb-4 flex items-center">
                        ...
                        Meal Planning for {selectedDosha} Balance
                      </h3>
                      <p className="text-muted-foreground mb-6">
                        Plan your meals throughout the week to maintain balance in your {selectedDosha} dosha.
                      </p>
                        ...
                        <div className="border border-border rounded-lg p-4">
                          ...
                          <ul className="space-y-2">
                            <li className="flex items-start">
                              ...
                              <span>Wake up early (before 6 AM)</span>
                            </li>
                            <li className="flex items-start">
                              <ArrowRight className="h-4 w-4 text-primary mr-2 mt-1 flex-shrink-0" />
                              <span>Drink warm water with lemon</span>
                            </li>
                            <li className="flex items-start">
                              <ArrowRight className="h-4 w-4 text-primary mr-2 mt-1 flex-shrink-0" />
                              <span>Eat breakfast before 8 AM</span>
                            </li>
                          </ul>
                        </div>
                        <div className="border border-border rounded-lg p-4">
                          <h4 className="font-medium mb-2">Evening Routine</h4>
                          <ul className="space-y-2">
                            <li className="flex items-start">
                              <ArrowRight className="h-4 w-4 text-primary mr-2 mt-1 flex-shrink-0" />
                              <span>Eat dinner before 7 PM</span>
                            </li>
                            <li className="flex items-start">
                              <ArrowRight className="h-4 w-4 text-primary mr-2 mt-1 flex-shrink-0" />
                              <span>Take a short walk after dinner</span>
                            </li>
                            <li className="flex items-start">
                              <ArrowRight className="h-4 w-4 text-primary mr-2 mt-1 flex-shrink-0" />
                              <span>Drink herbal tea before bed</span>
                            </li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <div className="mt-8 flex justify-center">
                        <Button className="flex items-center gap-2">
                          <CalendarDays className="h-4 w-4" />
                          <span>Create Custom Meal Plan</span>
                        </Button>
                      </div>
                    </div>
                  </TabsContent>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-5xl mx-auto">
              <h2 className="heading-md text-center mb-2">Plant-Based Diet for Health Conditions</h2>
              <p className="text-center text-muted-foreground mb-12">
                Visualize how different plant-based foods support various health conditions
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                {healthConditions.slice(0, 3).map((condition, index) => (
                  <AnimatedCard
                    ...
                    className={selectedHealthCondition === condition.id ? "ring-2 ring-primary" : ""}
                  />
                ))}
              </div>
              
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {healthConditions.slice(3).map((condition, index) => (
                  <AnimatedCard
                    key={condition.id}
                    title={condition.name}
                    description={condition.description}
              ...
              {/* Selected Health Condition Visualization */}
              {selectedHealthCondition && (
                <div className="mt-16 animate-fade-up">
                  <div className="bg-card border border-border rounded-xl p-8 shadow-sm">
                    <h3 className="font-medium text-xl mb-6 text-center">
                      Recommended Foods for {healthConditions.find(c => c.id === selectedHealthCondition)?.name}
                    </h3>
                    
                    <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                      {healthConditions.find(c => c.id === selectedHealthCondition)?.recommendations.map((food) => (
                        <div 
                          key={food.name}
                        ...
                        >
                          ...
                          >
                            <span className="text-white font-medium">{food.name.charAt(0)}</span>
                          </div>
                          <h4 className="font-medium text-center mb-1">{food.name}</h4>
                          <p className="text-xs text-center text-muted-foreground">{food.benefits}</p>
                        </div>
                      ))}
                    </div>
                    ...
                    <div className="mt-8 flex justify-center">
                      <Button 
                        variant="outline"
                        onClick={() => setSelectedHealthCondition(null)}
                        className="mr-4"
                      >
                        View All Conditions
                      </Button>
